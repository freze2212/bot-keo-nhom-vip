@echo off
chcp 65001 >nul
title XEM BROWSER NS3
color 0A
echo.
echo ============================================
echo   XEM BROWSER NS3 - Firefox tren man hinh RDP
echo ============================================
echo Dang STOP BCR-session3 (service chay ngam)...
"C:\tools\nssm\nssm-2.24\win64\nssm.exe" stop BCR-session3
...
echo.
echo Khoi dong lai BCR-session3 service...
"C:\tools\nssm\nssm-2.24\win64\nssm.exe" start BCR-session3
pause
