@echo off
chcp 65001 >nul
title XEM BROWSER NS4
color 0A
echo.
echo ============================================
echo   XEM BROWSER NS4 - Firefox tren man hinh RDP
echo ============================================
echo Dang STOP BCR-session4 (service chay ngam)...
"C:\tools\nssm\nssm-2.24\win64\nssm.exe" stop BCR-session4
...
echo.
echo Khoi dong lai BCR-session4 service...
"C:\tools\nssm\nssm-2.24\win64\nssm.exe" start BCR-session4
pause
